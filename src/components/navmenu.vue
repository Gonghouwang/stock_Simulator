  ...
  <el-row>
    <el-menu router
      ...
      <el-col span="8" style="display: flex; justify-content: center; ">
        <div style="padding: 0; height: 56px;">
          <img src="../assets/logo.svg" alt="logo" style="padding-top: 10px; color: #409EFF">
        </div>
      </el-col>
      <el-col span="8" style="display: flex; justify-content: flex-end; ">
        <div class="button-container">
          <span v-if="this.$store.isLogged"> Hi! {{ this.$store.username }} </span>

          <button class="Btn" v-if="this.$store.isLogged" @click="logout()">
            <div class="sign">
          ...
          <button class="Btn" v-if="!this.$store.isLogged" @click="goLogin()">
            <div class="sign">
              <svg viewBox="0 0 512 512">
